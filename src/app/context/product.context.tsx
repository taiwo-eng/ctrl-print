...
export default function ProductContext({
    ...
    const [products, setProducts] = useState([
        ...
        // JEWELRY 
        {name: 'Zuri Floral earrings', color: 'Gold plated', id: '8', description: 'Gold plated jewelry wire and cowrie shell', price: '35', tag:"jewelry", category: 'jewelry'},

        {name: 'Cowrie Petal Earrings', color: 'Gold plated', id: '19', description: "Cowrie Petal Earring set in Gold plated jewelry wire.", price: '30', tag:"jewelry", category: 'jewelry'},
        
        {name: 'Zula Cowrie Earcuff', color: 'Gold plated', id: '20', description: "Cowrie Ear cuffs set in Gold plated jewelry wire.", price: '35', tag:"jewelry", category: 'jewelry'},
        
        {name: 'Ashanti minimal Earrings', color: 'Gold plated', id: '10', description: 'Gold plated earrings with pearls', price: '35', tag:"jewelry", category: 'jewelry'},
        ...
        {name: 'Amira Cowrie hoops', color: 'Gold plated', id: '21', description: "Cowrie ear rings in gold plated jewelry wire with hoop detail.", price: '35', tag:"jewelry", category: 'jewelry'},
