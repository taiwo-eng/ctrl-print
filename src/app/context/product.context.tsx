...
export default function ProductContext({
    ...
    const [products, setProducts] = useState([
        ...
        {name: 'Yosola Bubu: Multicolour Gown', color: 'Green, Orange, & Blue', id: '3', description: "Our Yosola Adire gown is a stunning fusion of contemporary style and West African artistry. Ethically dyed and crafted from soft, breathable cotton, this dress is a wardrobe essential that radiates elegance and cultural richness. The eye-catching Orange, Green and blue prints are guaranteed to elevate every wardrobe."}, 

        {name: 'Yosola Bubu: Geometric Midi Gown', color: 'Mustard', id: '7', description: "Our Yosola Adire gown is a stunning fusion of contemporary style and West African artistry. Ethically dyed and crafted from soft, breathable cotton, this dress is a wardrobe essential that radiates elegance and cultural richness. This eye-catching piece, made from pure cotton, features a rich mustard palette with intricate geometric patterns."}, 

        {name: 'Yosola Bubu: XO Pattern multicolour Gown', color: 'Green, Orange, Purple, & Pink', id: '4', description: "Our Yosola Adire gown is a stunning fusion of contemporary style and West African artistry. Ethically dyed and crafted from soft, breathable cotton, this dress is a wardrobe essential that radiates elegance and cultural richness. The fabric has a repeating pattern of intersecting 'X' and 'O' shapes, arranged in a grid-like formation. A geometric design that gives the fabric a lively and modern look."}, 
